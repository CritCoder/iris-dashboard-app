...
async function main() {
  console.log('Processing API calls with improved extraction...');
  ...
  internalEndpoints.forEach(ep => console.log(`  ${ep.method} ${ep.endpoint} (Status: ${ep.status}, used on: ${Array.from(ep.pages).join(', ')})`));
